/*!
 * color.js 0.0.1 - https://github.com/yckart/color.js
...
(function (factory) {
    ...
    var color = {
        ...
        toHEX: function (color) {
            ...
            color = arguments.length > 1 ? color = [].slice.call(arguments).join(",").match(/\d+/g) : this.toArray(color);
    ...
    window.color = color;
    if (window.jQuery || window.Zepto) $.color = color;
}));